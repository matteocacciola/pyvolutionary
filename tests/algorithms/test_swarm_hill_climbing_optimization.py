...
from pyvolutionary import OptimizationResult, SwarmHillClimbingOptimization, SwarmHillClimbingOptimizationConfig
...
def optimization_config() -> SwarmHillClimbingOptimizationConfig:
    return SwarmHillClimbingOptimizationConfig(
        population_size=20, fitness_error=0.01, max_cycles=10, neighbour_size=8
    )


def test_valid_optimization(optimization_config):
    o = SwarmHillClimbingOptimization(optimization_config)
