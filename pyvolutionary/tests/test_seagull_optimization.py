...
from pyvolutionary import OptimizationResult, SeagullOptimization, SeagullOptimizationConfig
from pyvolutionary.tests.fixtures import task


@pytest.fixture
def optimization_config() -> SeagullOptimizationConfig:
    return SeagullOptimizationConfig(
        population_size=20,
        fitness_error=0.01,
        max_cycles=100,
        fc=2.5,
...
def test_valid_optimization(optimization_config):
    o = SeagullOptimization(optimization_config)
