...
from pyvolutionary import OptimizationResult, WaterCycleOptimization, WaterCycleOptimizationConfig
from pyvolutionary.tests.fixtures import task


@pytest.fixture
def optimization_config() -> WaterCycleOptimizationConfig:
...
def test_valid_optimization(optimization_config):
    o = WaterCycleOptimization(optimization_config)
