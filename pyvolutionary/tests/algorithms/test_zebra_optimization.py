...
from pyvolutionary import OptimizationResult, ZebraOptimization, ZebraOptimizationConfig
from pyvolutionary.tests.fixtures import task


@pytest.fixture
def optimization_config() -> ZebraOptimizationConfig:
    return ZebraOptimizationConfig(population_size=20, fitness_error=0.01, max_cycles=10)


def test_valid_optimization(optimization_config):
    o = ZebraOptimization(optimization_config)
