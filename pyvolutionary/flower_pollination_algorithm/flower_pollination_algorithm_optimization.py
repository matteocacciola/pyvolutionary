...
class FlowerPollinationAlgorithmOptimization(OptimizationAbstract):
    ...
    def __evolve__(self, pollinator: Pollinator, idx: int) -> Pollinator:
    ...
    def optimization_step(self):
        self._population = [self.__evolve__(pollinator, idx) for idx, pollinator in enumerate(self._population)]
