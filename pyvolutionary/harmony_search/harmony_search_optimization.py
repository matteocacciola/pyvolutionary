...
class HarmonySearchOptimization(OptimizationAbstract):
    ...
    def __create_new_harmony__(self, idx: int | None = None, harmony: Harmony | None = None) -> Harmony:
        """
        ...
        :param idx: the index of the harmony to be used (optional)
        :param harmony: a harmony to be used as a base to create a new harmony (optional)
    ...
    def optimization_step(self):
        pop_new = self._solve_mode_process(self.__create_new_harmony__)
